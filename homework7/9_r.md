...
More specifically, where X₁, …, Xₙ are independent and identically distributed random variables with the same arbitrary distribution, zero mean, and variance σ² and Z is their mean scaled by sqrt(n) 

...
It was Laplace who first posed the problem of aggregating several observations ina 1774, although his own solution led to the Laplace distribution.
...
More specifically, where X1, …, Xn are independet and identically distributed random variables with the same arbitrary distribution, zero mean, and variance σ2 and Z is their mean scaled by sqrt(n) 

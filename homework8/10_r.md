...
So by replacing the results shown to the first presented formula of P(y1 < X(1) ≤ x1, ..., yn < X(n) < xn) and taking the derivatives of both left and right side with respect to x1,x2,...,xn we obtain

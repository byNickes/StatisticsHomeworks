...
Before talking abuot the distributions of the order statistics let'ss see some notation:
...
Imagine a random sample falling in such a way that the minimum is below a fixed value x. It might
look like this
...
From the CDF of the minimum we can derive the PDF as follows
